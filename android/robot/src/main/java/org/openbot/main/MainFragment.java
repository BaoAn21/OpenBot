  ...
  public void onItemClick(SubCategory subCategory) {
    ...
    switch (subCategory.getTitle()) {
      ...
      case FeatureList.ROBOT_INFO:
        ...
        break;
      case FeatureList.LINE_OBJECT_RIDING:
        Navigation.findNavController(requireView())
                .navigate(R.id.action_mainFragment_to_lineObjectFragment);
        break;
      ...
      case FeatureList.LINE_OBJECT_TRACKING:
        Navigation.findNavController(requireView())
                .navigate(R.id.action_mainFragment_to_lineObjectTrackingFragment);
        break;
